...
def main():
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "/workspace/STFA"))  # get data root path
    image_path = os.path.join(data_root, "data_set", "face_8age_data")  # flower data set path
